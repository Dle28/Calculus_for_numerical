...
/**
 * Gửi yêu cầu tìm khoảng cách ly nghiệm từ dữ liệu bảng.
 * @param {FormData} formData - Có thể chứa file CSV hoặc dữ liệu nhập tay, cùng y_bar, k và kiểu mở rộng.
 * @returns {Promise<object>}
 */
export async function calculateFindIntervals(formData) {
